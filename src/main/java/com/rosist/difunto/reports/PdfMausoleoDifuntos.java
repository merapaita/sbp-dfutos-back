...
public class PdfMausoleoDifuntos {
...
//        System.out.println(sql);
        ...
        plantilla();
		tReporte = new Table(new float[]{40, 130, 40, 130, 130});
...
//					paragraph = new Paragraph();
    ...
    private void detalle(ResultSet rs2) throws SQLException {
        ...
        cell = new Cell()
        		.add(new Paragraph(String.valueOf(rs2.getString("nomdif")))
        		.setTextAlignment(TextAlignment.LEFT))
        		.setFont(fontContenido)
        		.setFontSize(8);
        tReporte.addCell(cell);
	...
	private void gMausoleo(ResultSet rs2) throws SQLException {
        ...
        cell = new Cell()
        		.add(new Paragraph(rs2.getString("familia"))
        		.setTextAlignment(TextAlignment.LEFT))
        		.setFont(fontContenido)
        		.setFontSize(8);
        tReporte.addCell(cell);
        ...
        cell = new Cell()
        		.add(new Paragraph(rs2.getString("destipmau"))
        		.setTextAlignment(TextAlignment.LEFT))
        		.setFont(fontContenido)
        		.setFontSize(8);
        tReporte.addCell(cell);
        ...
        cell = new Cell()
        		.add(new Paragraph(rs2.getString("ubicacion"))
        		.setTextAlignment(TextAlignment.LEFT))
        		.setFont(fontContenido)
        		.setFontSize(8);
        tReporte.addCell(cell);
