...
public class Ajuste {
	...
	@JsonIgnore
	@ManyToOne
	@JoinColumn(name = "codcre", nullable = false, foreignKey = @ForeignKey(name = "FK_ajuste_credito"))
	...
	@ManyToOne
	@JoinColumn(name = "codcli", nullable = false, foreignKey = @ForeignKey(name = "FK_cliente_ajuste"))
